...
/*AUTELAN-Begin:zhaoenjuan transplant (pwh) for drv_monitor tid_trace */
u_int32_t      	 tid_period_sec;
EXPORT_SYMBOL(tid_period_sec);
u_int32_t      	 tid_period_us;
EXPORT_SYMBOL(tid_period_us);
/*AUTELAN-End:zhaoenjuan transplant (pwh) for drv_monitor tid_trace */
...
/*Start mcast quene,huangtao added 2013-5-24*/
u_int32_t mcast_queue_debug = 0;
EXPORT_SYMBOL(mcast_queue_debug);
/*End mcast quene,huangtao added 2013-5-24*/
...
/*zhaoyang add end*/
/*AUTELAN-Begin:zhaoenjuan transplant for drv_monitor enable*/
u_int32_t autelan_drv_monitor_enable = 1;
EXPORT_SYMBOL(autelan_drv_monitor_enable);
/*AUTELAN-End:zhaoenjuan transplant for drv_monitor enable*/
...
#endif
/*suzhaoyu add end*/
/*AUTELAN--Begin:zhaoenjuan transplant (dmz) for drv_monitor when check too many bmiss reboot the device */
u_int32_t bmiss_check = 60;
EXPORT_SYMBOL(bmiss_check);
/*AUTELAN--End:zhaoenjuan transplant (dmz) for drv_monitor when check too many bmiss reboot the device */

/* Begin:gengzongjie added for rfid scan */
int rfid_scan = 0;
EXPORT_SYMBOL(rfid_scan);
/* End:gengzongjie added end */
